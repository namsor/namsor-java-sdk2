...
public class JapaneseApi {
     ...
     * @param batchFirstLastNameIn A list of personal japanese names in LATIN, firstName &#x3D; japaneseGivenName; lastName&#x3D;japaneseSurname and known gender (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call japaneseNameGenderKanjiCandidatesBatchCall(BatchFirstLastNameIn batchFirstLastNameIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchFirstLastNameIn;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call japaneseNameGenderKanjiCandidatesBatchValidateBeforeCall(BatchFirstLastNameIn batchFirstLastNameIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = japaneseNameGenderKanjiCandidatesBatchCall(batchFirstLastNameIn, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchNameMatchCandidatesOut japaneseNameGenderKanjiCandidatesBatch(BatchFirstLastNameIn batchFirstLastNameIn) throws ApiException {
        ApiResponse<BatchNameMatchCandidatesOut> resp = japaneseNameGenderKanjiCandidatesBatchWithHttpInfo(batchFirstLastNameIn);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchNameMatchCandidatesOut> japaneseNameGenderKanjiCandidatesBatchWithHttpInfo(BatchFirstLastNameIn batchFirstLastNameIn) throws ApiException {
        com.squareup.okhttp.Call call = japaneseNameGenderKanjiCandidatesBatchValidateBeforeCall(batchFirstLastNameIn, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call japaneseNameGenderKanjiCandidatesBatchAsync(BatchFirstLastNameIn batchFirstLastNameIn, final ApiCallback<BatchNameMatchCandidatesOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = japaneseNameGenderKanjiCandidatesBatchValidateBeforeCall(batchFirstLastNameIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchNameMatchCandidatesOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RomanizedNameOut japaneseNameKanjiCandidates(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender) throws ApiException {
        ApiResponse<RomanizedNameOut> resp = japaneseNameKanjiCandidatesWithHttpInfo(japaneseSurnameLatin, japaneseGivenNameLatin, knownGender);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RomanizedNameOut> japaneseNameKanjiCandidatesWithHttpInfo(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call japaneseNameKanjiCandidatesAsync(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender, final ApiCallback<RomanizedNameOut> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RomanizedNameOut japaneseNameKanjiCandidates1(String japaneseSurnameLatin, String japaneseGivenNameLatin) throws ApiException {
        ApiResponse<RomanizedNameOut> resp = japaneseNameKanjiCandidates1WithHttpInfo(japaneseSurnameLatin, japaneseGivenNameLatin);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RomanizedNameOut> japaneseNameKanjiCandidates1WithHttpInfo(String japaneseSurnameLatin, String japaneseGivenNameLatin) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call japaneseNameKanjiCandidates1Async(String japaneseSurnameLatin, String japaneseGivenNameLatin, final ApiCallback<RomanizedNameOut> callback) throws ApiException {
