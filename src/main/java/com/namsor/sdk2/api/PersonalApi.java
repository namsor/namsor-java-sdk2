...
import com.namsor.sdk2.model.BatchCorridorFullIn;
import com.namsor.sdk2.model.BatchCorridorFullOut;
...
public class PersonalApi {
    ...
    /**
     * Build call for communityEngage
     ...
     */
    public com.squareup.okhttp.Call communityEngageCall(String countryIso2, String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/communityEngage/{countryIso2}/{firstName}/{lastName}"
    ...
    private com.squareup.okhttp.Call communityEngageValidateBeforeCall(String countryIso2, String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'countryIso2' is set
        if (countryIso2 == null) {
            throw new ApiException("Missing the required parameter 'countryIso2' when calling communityEngage(Async)");
        }
        
        // verify the required parameter 'firstName' is set
        if (firstName == null) {
            throw new ApiException("Missing the required parameter 'firstName' when calling communityEngage(Async)");
        }
        
        // verify the required parameter 'lastName' is set
        if (lastName == null) {
            throw new ApiException("Missing the required parameter 'lastName' when calling communityEngage(Async)");
        }
        

        com.squareup.okhttp.Call call = communityEngageCall(countryIso2, firstName, lastName, progressListener, progressRequestListener);
        return call;
     ...
     */
    public CommunityEngageOut communityEngage(String countryIso2, String firstName, String lastName) throws ApiException {
        ApiResponse<CommunityEngageOut> resp = communityEngageWithHttpInfo(countryIso2, firstName, lastName);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CommunityEngageOut> communityEngageWithHttpInfo(String countryIso2, String firstName, String lastName) throws ApiException {
        com.squareup.okhttp.Call call = communityEngageValidateBeforeCall(countryIso2, firstName, lastName, null, null);
        Type localVarReturnType = new TypeToken<CommunityEngageOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * [USES 20 UNITS PER NAME] Infer the likely ethnicity/diaspora, country, gender of a personal name, given a country of residence ISO2 code (ex. US, CA, AU, NZ etc.) for community engagement (require special module/pricing) (asynchronously)
     * 
     * @param countryIso2  (required)
     * @param firstName  (required)
     * @param lastName  (required)
     ...
     */
    public com.squareup.okhttp.Call communityEngageAsync(String countryIso2, String firstName, String lastName, final ApiCallback<CommunityEngageOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = communityEngageValidateBeforeCall(countryIso2, firstName, lastName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CommunityEngageOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for communityEngageBatch
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call communityEngageBatchCall(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchFirstLastNameGeoIn;

        // create path and map variables
        String localVarPath = "/api2/json/communityEngageBatch";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call communityEngageBatchValidateBeforeCall(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = communityEngageBatchCall(batchFirstLastNameGeoIn, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchCommunityEngageOut communityEngageBatch(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn) throws ApiException {
        ApiResponse<BatchCommunityEngageOut> resp = communityEngageBatchWithHttpInfo(batchFirstLastNameGeoIn);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchCommunityEngageOut> communityEngageBatchWithHttpInfo(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn) throws ApiException {
        com.squareup.okhttp.Call call = communityEngageBatchValidateBeforeCall(batchFirstLastNameGeoIn, null, null);
        Type localVarReturnType = new TypeToken<BatchCommunityEngageOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Infer the likely ethnicity/diaspora, country, gender of up to 100 personal names, given a country of residence ISO2 code (ex. US, CA, AU, NZ etc.) for community engagement (require special module/pricing) (asynchronously)
     * 
     * @param batchFirstLastNameGeoIn A list of personal names (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call communityEngageBatchAsync(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn, final ApiCallback<BatchCommunityEngageOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = communityEngageBatchValidateBeforeCall(batchFirstLastNameGeoIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchCommunityEngageOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for communityEngageFull
     * @param countryIso2  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call communityEngageFullCall(String countryIso2, String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/communityEngageFull/{countryIso2}/{personalNameFull}"
            .replaceAll("\\{" + "countryIso2" + "\\}", apiClient.escapeString(countryIso2.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call communityEngageFullValidateBeforeCall(String countryIso2, String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'countryIso2' is set
        if (countryIso2 == null) {
            throw new ApiException("Missing the required parameter 'countryIso2' when calling communityEngageFull(Async)");
        }
        
        // verify the required parameter 'personalNameFull' is set
        if (personalNameFull == null) {
            throw new ApiException("Missing the required parameter 'personalNameFull' when calling communityEngageFull(Async)");
        }
        

        com.squareup.okhttp.Call call = communityEngageFullCall(countryIso2, personalNameFull, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CommunityEngageOut communityEngageFull(String countryIso2, String personalNameFull) throws ApiException {
        ApiResponse<CommunityEngageOut> resp = communityEngageFullWithHttpInfo(countryIso2, personalNameFull);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CommunityEngageOut> communityEngageFullWithHttpInfo(String countryIso2, String personalNameFull) throws ApiException {
        com.squareup.okhttp.Call call = communityEngageFullValidateBeforeCall(countryIso2, personalNameFull, null, null);
        Type localVarReturnType = new TypeToken<CommunityEngageOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call communityEngageFullAsync(String countryIso2, String personalNameFull, final ApiCallback<CommunityEngageOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = communityEngageFullValidateBeforeCall(countryIso2, personalNameFull, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CommunityEngageOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for communityEngageFullBatch
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call communityEngageFullBatchCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchPersonalNameGeoIn;

        // create path and map variables
        String localVarPath = "/api2/json/communityEngageFullBatch";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call communityEngageFullBatchValidateBeforeCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = communityEngageFullBatchCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchCommunityEngageFullOut communityEngageFullBatch(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        ApiResponse<BatchCommunityEngageFullOut> resp = communityEngageFullBatchWithHttpInfo(batchPersonalNameGeoIn);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchCommunityEngageFullOut> communityEngageFullBatchWithHttpInfo(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        com.squareup.okhttp.Call call = communityEngageFullBatchValidateBeforeCall(batchPersonalNameGeoIn, null, null);
        Type localVarReturnType = new TypeToken<BatchCommunityEngageFullOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call communityEngageFullBatchAsync(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ApiCallback<BatchCommunityEngageFullOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = communityEngageFullBatchValidateBeforeCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchCommunityEngageFullOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call corridorCall(String countryIso2From, String firstNameFrom, String lastNameFrom, String countryIso2To, String firstNameTo, String lastNameTo, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/corridor/{countryIso2From}/{firstNameFrom}/{lastNameFrom}/{countryIso2To}/{firstNameTo}/{lastNameTo}"
            .replaceAll("\\{" + "countryIso2From" + "\\}", apiClient.escapeString(countryIso2From.toString()))
            .replaceAll("\\{" + "firstNameFrom" + "\\}", apiClient.escapeString(firstNameFrom.toString()))
            .replaceAll("\\{" + "lastNameFrom" + "\\}", apiClient.escapeString(lastNameFrom.toString()))
            .replaceAll("\\{" + "countryIso2To" + "\\}", apiClient.escapeString(countryIso2To.toString()))
            .replaceAll("\\{" + "firstNameTo" + "\\}", apiClient.escapeString(firstNameTo.toString()))
            .replaceAll("\\{" + "lastNameTo" + "\\}", apiClient.escapeString(lastNameTo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call corridorValidateBeforeCall(String countryIso2From, String firstNameFrom, String lastNameFrom, String countryIso2To, String firstNameTo, String lastNameTo, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = corridorCall(countryIso2From, firstNameFrom, lastNameFrom, countryIso2To, firstNameTo, lastNameTo, progressListener, progressRequestListener);
        return call;
    ...
    public CorridorOut corridor(String countryIso2From, String firstNameFrom, String lastNameFrom, String countryIso2To, String firstNameTo, String lastNameTo) throws ApiException {
        ApiResponse<CorridorOut> resp = corridorWithHttpInfo(countryIso2From, firstNameFrom, lastNameFrom, countryIso2To, firstNameTo, lastNameTo);
        return resp.getData();
    }
    ...
    public ApiResponse<CorridorOut> corridorWithHttpInfo(String countryIso2From, String firstNameFrom, String lastNameFrom, String countryIso2To, String firstNameTo, String lastNameTo) throws ApiException {
        com.squareup.okhttp.Call call = corridorValidateBeforeCall(countryIso2From, firstNameFrom, lastNameFrom, countryIso2To, firstNameTo, lastNameTo, null, null);
        Type localVarReturnType = new TypeToken<CorridorOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * [USES 50 UNITS PER NAME COUPLE] Infer several classifications for a cross border interaction between names (ex. remit, travel, intl com) (asynchronously)
     * 
     * @param countryIso2From  (required)
     * @param firstNameFrom  (required)
     * @param lastNameFrom  (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call corridorAsync(String countryIso2From, String firstNameFrom, String lastNameFrom, String countryIso2To, String firstNameTo, String lastNameTo, final ApiCallback<CorridorOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = corridorValidateBeforeCall(countryIso2From, firstNameFrom, lastNameFrom, countryIso2To, firstNameTo, lastNameTo, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CorridorOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call corridorBatchCall(BatchCorridorIn batchCorridorIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call corridorBatchValidateBeforeCall(BatchCorridorIn batchCorridorIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = corridorBatchCall(batchCorridorIn, progressListener, progressRequestListener);
        return call;
    ...
    public BatchCorridorOut corridorBatch(BatchCorridorIn batchCorridorIn) throws ApiException {
        ApiResponse<BatchCorridorOut> resp = corridorBatchWithHttpInfo(batchCorridorIn);
        return resp.getData();
    }
    ...
    public ApiResponse<BatchCorridorOut> corridorBatchWithHttpInfo(BatchCorridorIn batchCorridorIn) throws ApiException {
        com.squareup.okhttp.Call call = corridorBatchValidateBeforeCall(batchCorridorIn, null, null);
        Type localVarReturnType = new TypeToken<BatchCorridorOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * [USES 50 UNITS PER NAME PAIR] Infer several classifications for up to 100 cross border interaction between names (ex. remit, travel, intl com) (asynchronously)
     * 
     * @param batchCorridorIn A list of name pairs, with country code (nameFrom -&gt; nameTo). (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call corridorBatchAsync(BatchCorridorIn batchCorridorIn, final ApiCallback<BatchCorridorOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = corridorBatchValidateBeforeCall(batchCorridorIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchCorridorOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for corridorFull
     * @param countryIso2From  (required)
     * @param personalNameFrom  (required)
     * @param countryIso2To  (required)
     * @param personalNameTo  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call corridorFullCall(String countryIso2From, String personalNameFrom, String countryIso2To, String personalNameTo, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/corridorFull/{countryIso2From}/{personalNameFrom}/{countryIso2To}/{personalNameTo}"
            .replaceAll("\\{" + "countryIso2From" + "\\}", apiClient.escapeString(countryIso2From.toString()))
            .replaceAll("\\{" + "personalNameFrom" + "\\}", apiClient.escapeString(personalNameFrom.toString()))
            .replaceAll("\\{" + "countryIso2To" + "\\}", apiClient.escapeString(countryIso2To.toString()))
            .replaceAll("\\{" + "personalNameTo" + "\\}", apiClient.escapeString(personalNameTo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call corridorFullValidateBeforeCall(String countryIso2From, String personalNameFrom, String countryIso2To, String personalNameTo, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'countryIso2From' is set
        if (countryIso2From == null) {
            throw new ApiException("Missing the required parameter 'countryIso2From' when calling corridorFull(Async)");
        }
        
        // verify the required parameter 'personalNameFrom' is set
        if (personalNameFrom == null) {
            throw new ApiException("Missing the required parameter 'personalNameFrom' when calling corridorFull(Async)");
        }
        
        // verify the required parameter 'countryIso2To' is set
        if (countryIso2To == null) {
            throw new ApiException("Missing the required parameter 'countryIso2To' when calling corridorFull(Async)");
        }
        
        // verify the required parameter 'personalNameTo' is set
        if (personalNameTo == null) {
            throw new ApiException("Missing the required parameter 'personalNameTo' when calling corridorFull(Async)");
        }
        

        com.squareup.okhttp.Call call = corridorFullCall(countryIso2From, personalNameFrom, countryIso2To, personalNameTo, progressListener, progressRequestListener);
        return call;
     ...
     * @param countryIso2To  (required)
     * @param personalNameTo  (required)
     * @return CorridorFullOut
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CorridorFullOut corridorFull(String countryIso2From, String personalNameFrom, String countryIso2To, String personalNameTo) throws ApiException {
        ApiResponse<CorridorFullOut> resp = corridorFullWithHttpInfo(countryIso2From, personalNameFrom, countryIso2To, personalNameTo);
        return resp.getData();
    }
     ...
     * @param countryIso2To  (required)
     * @param personalNameTo  (required)
     * @return ApiResponse&lt;CorridorFullOut&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CorridorFullOut> corridorFullWithHttpInfo(String countryIso2From, String personalNameFrom, String countryIso2To, String personalNameTo) throws ApiException {
        com.squareup.okhttp.Call call = corridorFullValidateBeforeCall(countryIso2From, personalNameFrom, countryIso2To, personalNameTo, null, null);
        Type localVarReturnType = new TypeToken<CorridorFullOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call corridorFullAsync(String countryIso2From, String personalNameFrom, String countryIso2To, String personalNameTo, final ApiCallback<CorridorFullOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = corridorFullValidateBeforeCall(countryIso2From, personalNameFrom, countryIso2To, personalNameTo, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CorridorFullOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for corridorFullBatch
     * @param batchCorridorFullIn A list of name pairs, with country code (nameFrom -&gt; nameTo). (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call corridorFullBatchCall(BatchCorridorFullIn batchCorridorFullIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchCorridorFullIn;

        // create path and map variables
        String localVarPath = "/api2/json/corridorFullBatch";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call corridorFullBatchValidateBeforeCall(BatchCorridorFullIn batchCorridorFullIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = corridorFullBatchCall(batchCorridorFullIn, progressListener, progressRequestListener);
        return call;
     ...
     * 
     * @param batchCorridorFullIn A list of name pairs, with country code (nameFrom -&gt; nameTo). (optional)
     * @return BatchCorridorFullOut
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchCorridorFullOut corridorFullBatch(BatchCorridorFullIn batchCorridorFullIn) throws ApiException {
        ApiResponse<BatchCorridorFullOut> resp = corridorFullBatchWithHttpInfo(batchCorridorFullIn);
        return resp.getData();
    }
     ...
     * 
     * @param batchCorridorFullIn A list of name pairs, with country code (nameFrom -&gt; nameTo). (optional)
     * @return ApiResponse&lt;BatchCorridorFullOut&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchCorridorFullOut> corridorFullBatchWithHttpInfo(BatchCorridorFullIn batchCorridorFullIn) throws ApiException {
        com.squareup.okhttp.Call call = corridorFullBatchValidateBeforeCall(batchCorridorFullIn, null, null);
        Type localVarReturnType = new TypeToken<BatchCorridorFullOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call corridorFullBatchAsync(BatchCorridorFullIn batchCorridorFullIn, final ApiCallback<BatchCorridorFullOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = corridorFullBatchValidateBeforeCall(batchCorridorFullIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchCorridorFullOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call countryFnLnCall(String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/countryFnLn/{firstName}/{lastName}"
            .replaceAll("\\{" + "firstName" + "\\}", apiClient.escapeString(firstName.toString()))
            .replaceAll("\\{" + "lastName" + "\\}", apiClient.escapeString(lastName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call countryFnLnValidateBeforeCall(String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'firstName' is set
        if (firstName == null) {
            throw new ApiException("Missing the required parameter 'firstName' when calling countryFnLn(Async)");
        }
        
        // verify the required parameter 'lastName' is set
        if (lastName == null) {
            throw new ApiException("Missing the required parameter 'lastName' when calling countryFnLn(Async)");
        }
        

        com.squareup.okhttp.Call call = countryFnLnCall(firstName, lastName, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FirstLastNameOriginedOut countryFnLn(String firstName, String lastName) throws ApiException {
        ApiResponse<FirstLastNameOriginedOut> resp = countryFnLnWithHttpInfo(firstName, lastName);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FirstLastNameOriginedOut> countryFnLnWithHttpInfo(String firstName, String lastName) throws ApiException {
        com.squareup.okhttp.Call call = countryFnLnValidateBeforeCall(firstName, lastName, null, null);
        Type localVarReturnType = new TypeToken<FirstLastNameOriginedOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * [USES 10 UNITS PER NAME] Infer the likely country of residence of a personal first / last name, or one surname. Assumes names as they are in the country of residence OR the country of origin. (asynchronously)
     * 
     * @param firstName  (required)
     * @param lastName  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call countryFnLnAsync(String firstName, String lastName, final ApiCallback<FirstLastNameOriginedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = countryFnLnValidateBeforeCall(firstName, lastName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FirstLastNameOriginedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for countryFnLnBatch
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call countryFnLnBatchCall(BatchFirstLastNameIn batchFirstLastNameIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchFirstLastNameIn;

        // create path and map variables
        String localVarPath = "/api2/json/countryFnLnBatch";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call countryFnLnBatchValidateBeforeCall(BatchFirstLastNameIn batchFirstLastNameIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = countryFnLnBatchCall(batchFirstLastNameIn, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchFirstLastNameGeoOut countryFnLnBatch(BatchFirstLastNameIn batchFirstLastNameIn) throws ApiException {
        ApiResponse<BatchFirstLastNameGeoOut> resp = countryFnLnBatchWithHttpInfo(batchFirstLastNameIn);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchFirstLastNameGeoOut> countryFnLnBatchWithHttpInfo(BatchFirstLastNameIn batchFirstLastNameIn) throws ApiException {
        com.squareup.okhttp.Call call = countryFnLnBatchValidateBeforeCall(batchFirstLastNameIn, null, null);
        Type localVarReturnType = new TypeToken<BatchFirstLastNameGeoOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * [USES 10 UNITS PER NAME] Infer the likely country of residence of up to 100 personal first / last names, or surnames. Assumes names as they are in the country of residence OR the country of origin. (asynchronously)
     * 
     * @param batchFirstLastNameIn A list of personal names (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call countryFnLnBatchAsync(BatchFirstLastNameIn batchFirstLastNameIn, final ApiCallback<BatchFirstLastNameGeoOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = countryFnLnBatchValidateBeforeCall(batchFirstLastNameIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchFirstLastNameGeoOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call diasporaFullCall(String countryIso2, String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/diasporaFull/{countryIso2}/{personalNameFull}"
            .replaceAll("\\{" + "countryIso2" + "\\}", apiClient.escapeString(countryIso2.toString()))
            .replaceAll("\\{" + "personalNameFull" + "\\}", apiClient.escapeString(personalNameFull.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call diasporaFullValidateBeforeCall(String countryIso2, String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'countryIso2' is set
        if (countryIso2 == null) {
            throw new ApiException("Missing the required parameter 'countryIso2' when calling diasporaFull(Async)");
        }
        
        // verify the required parameter 'personalNameFull' is set
        if (personalNameFull == null) {
            throw new ApiException("Missing the required parameter 'personalNameFull' when calling diasporaFull(Async)");
        }
        

        com.squareup.okhttp.Call call = diasporaFullCall(countryIso2, personalNameFull, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PersonalNameDiasporaedOut diasporaFull(String countryIso2, String personalNameFull) throws ApiException {
        ApiResponse<PersonalNameDiasporaedOut> resp = diasporaFullWithHttpInfo(countryIso2, personalNameFull);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PersonalNameDiasporaedOut> diasporaFullWithHttpInfo(String countryIso2, String personalNameFull) throws ApiException {
        com.squareup.okhttp.Call call = diasporaFullValidateBeforeCall(countryIso2, personalNameFull, null, null);
        Type localVarReturnType = new TypeToken<PersonalNameDiasporaedOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call diasporaFullAsync(String countryIso2, String personalNameFull, final ApiCallback<PersonalNameDiasporaedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = diasporaFullValidateBeforeCall(countryIso2, personalNameFull, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PersonalNameDiasporaedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for diasporaFullBatch
     * @param batchPersonalNameGeoIn A list of personal names (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call diasporaFullBatchCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchPersonalNameGeoIn;

        // create path and map variables
        String localVarPath = "/api2/json/diasporaFullBatch";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call diasporaFullBatchValidateBeforeCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = diasporaFullBatchCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchPersonalNameDiasporaedOut diasporaFullBatch(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        ApiResponse<BatchPersonalNameDiasporaedOut> resp = diasporaFullBatchWithHttpInfo(batchPersonalNameGeoIn);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchPersonalNameDiasporaedOut> diasporaFullBatchWithHttpInfo(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        com.squareup.okhttp.Call call = diasporaFullBatchValidateBeforeCall(batchPersonalNameGeoIn, null, null);
        Type localVarReturnType = new TypeToken<BatchPersonalNameDiasporaedOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call diasporaFullBatchAsync(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ApiCallback<BatchPersonalNameDiasporaedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = diasporaFullBatchValidateBeforeCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchPersonalNameDiasporaedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call genderCall(String firstName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call genderValidateBeforeCall(String firstName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = genderCall(firstName, progressListener, progressRequestListener);
        return call;
    ...
    public FirstLastNameGenderedOut gender(String firstName) throws ApiException {
        ApiResponse<FirstLastNameGenderedOut> resp = genderWithHttpInfo(firstName);
        return resp.getData();
    }
    ...
    public ApiResponse<FirstLastNameGenderedOut> genderWithHttpInfo(String firstName) throws ApiException {
        com.squareup.okhttp.Call call = genderValidateBeforeCall(firstName, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call genderAsync(String firstName, final ApiCallback<FirstLastNameGenderedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = genderValidateBeforeCall(firstName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FirstLastNameGenderedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call gender1Call(String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call gender1ValidateBeforeCall(String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = gender1Call(firstName, lastName, progressListener, progressRequestListener);
        return call;
    ...
    public FirstLastNameGenderedOut gender1(String firstName, String lastName) throws ApiException {
        ApiResponse<FirstLastNameGenderedOut> resp = gender1WithHttpInfo(firstName, lastName);
        return resp.getData();
    }
    ...
    public ApiResponse<FirstLastNameGenderedOut> gender1WithHttpInfo(String firstName, String lastName) throws ApiException {
        com.squareup.okhttp.Call call = gender1ValidateBeforeCall(firstName, lastName, null, null);
        Type localVarReturnType = new TypeToken<FirstLastNameGenderedOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call gender1Async(String firstName, String lastName, final ApiCallback<FirstLastNameGenderedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = gender1ValidateBeforeCall(firstName, lastName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FirstLastNameGenderedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public PersonalNameGenderedOut genderFull(String fullName) throws ApiException {
        ApiResponse<PersonalNameGenderedOut> resp = genderFullWithHttpInfo(fullName);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call genderFullAsync(String fullName, final ApiCallback<PersonalNameGenderedOut> callback) throws ApiException {
    ...
    public PersonalNameGenderedOut genderFullGeo(String fullName, String countryIso2) throws ApiException {
        ApiResponse<PersonalNameGenderedOut> resp = genderFullGeoWithHttpInfo(fullName, countryIso2);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call genderFullGeoAsync(String fullName, String countryIso2, final ApiCallback<PersonalNameGenderedOut> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call originFullCall(String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/originFull/{personalNameFull}"
            .replaceAll("\\{" + "personalNameFull" + "\\}", apiClient.escapeString(personalNameFull.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call originFullValidateBeforeCall(String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'personalNameFull' is set
        if (personalNameFull == null) {
            throw new ApiException("Missing the required parameter 'personalNameFull' when calling originFull(Async)");
        }
        

        com.squareup.okhttp.Call call = originFullCall(personalNameFull, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PersonalNameOriginedOut originFull(String personalNameFull) throws ApiException {
        ApiResponse<PersonalNameOriginedOut> resp = originFullWithHttpInfo(personalNameFull);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PersonalNameOriginedOut> originFullWithHttpInfo(String personalNameFull) throws ApiException {
        com.squareup.okhttp.Call call = originFullValidateBeforeCall(personalNameFull, null, null);
        Type localVarReturnType = new TypeToken<PersonalNameOriginedOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call originFullAsync(String personalNameFull, final ApiCallback<PersonalNameOriginedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = originFullValidateBeforeCall(personalNameFull, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PersonalNameOriginedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for originFullBatch
     * @param batchPersonalNameIn A list of personal names (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call originFullBatchCall(BatchPersonalNameIn batchPersonalNameIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchPersonalNameIn;

        // create path and map variables
        String localVarPath = "/api2/json/originFullBatch";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call originFullBatchValidateBeforeCall(BatchPersonalNameIn batchPersonalNameIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = originFullBatchCall(batchPersonalNameIn, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchPersonalNameOriginedOut originFullBatch(BatchPersonalNameIn batchPersonalNameIn) throws ApiException {
        ApiResponse<BatchPersonalNameOriginedOut> resp = originFullBatchWithHttpInfo(batchPersonalNameIn);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchPersonalNameOriginedOut> originFullBatchWithHttpInfo(BatchPersonalNameIn batchPersonalNameIn) throws ApiException {
        com.squareup.okhttp.Call call = originFullBatchValidateBeforeCall(batchPersonalNameIn, null, null);
        Type localVarReturnType = new TypeToken<BatchPersonalNameOriginedOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call originFullBatchAsync(BatchPersonalNameIn batchPersonalNameIn, final ApiCallback<BatchPersonalNameOriginedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = originFullBatchValidateBeforeCall(batchPersonalNameIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchPersonalNameOriginedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call religion2Call(String countryIso2, String subDivisionIso31662, String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call religion2ValidateBeforeCall(String countryIso2, String subDivisionIso31662, String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = religion2Call(countryIso2, subDivisionIso31662, firstName, lastName, progressListener, progressRequestListener);
        return call;
    ...
    public FirstLastNameReligionedOut religion2(String countryIso2, String subDivisionIso31662, String firstName, String lastName) throws ApiException {
        ApiResponse<FirstLastNameReligionedOut> resp = religion2WithHttpInfo(countryIso2, subDivisionIso31662, firstName, lastName);
        return resp.getData();
    }
    ...
    public ApiResponse<FirstLastNameReligionedOut> religion2WithHttpInfo(String countryIso2, String subDivisionIso31662, String firstName, String lastName) throws ApiException {
        com.squareup.okhttp.Call call = religion2ValidateBeforeCall(countryIso2, subDivisionIso31662, firstName, lastName, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call religion2Async(String countryIso2, String subDivisionIso31662, String firstName, String lastName, final ApiCallback<FirstLastNameReligionedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = religion2ValidateBeforeCall(countryIso2, subDivisionIso31662, firstName, lastName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FirstLastNameReligionedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call religionBatchCall(BatchFirstLastNameGeoSubdivisionIn batchFirstLastNameGeoSubdivisionIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call religionBatchValidateBeforeCall(BatchFirstLastNameGeoSubdivisionIn batchFirstLastNameGeoSubdivisionIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = religionBatchCall(batchFirstLastNameGeoSubdivisionIn, progressListener, progressRequestListener);
        return call;
    ...
    public BatchFirstLastNameReligionedOut religionBatch(BatchFirstLastNameGeoSubdivisionIn batchFirstLastNameGeoSubdivisionIn) throws ApiException {
        ApiResponse<BatchFirstLastNameReligionedOut> resp = religionBatchWithHttpInfo(batchFirstLastNameGeoSubdivisionIn);
        return resp.getData();
    }
    ...
    public ApiResponse<BatchFirstLastNameReligionedOut> religionBatchWithHttpInfo(BatchFirstLastNameGeoSubdivisionIn batchFirstLastNameGeoSubdivisionIn) throws ApiException {
        com.squareup.okhttp.Call call = religionBatchValidateBeforeCall(batchFirstLastNameGeoSubdivisionIn, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call religionBatchAsync(BatchFirstLastNameGeoSubdivisionIn batchFirstLastNameGeoSubdivisionIn, final ApiCallback<BatchFirstLastNameReligionedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = religionBatchValidateBeforeCall(batchFirstLastNameGeoSubdivisionIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchFirstLastNameReligionedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call religionFullCall(String countryIso2, String subDivisionIso31662, String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call religionFullValidateBeforeCall(String countryIso2, String subDivisionIso31662, String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = religionFullCall(countryIso2, subDivisionIso31662, personalNameFull, progressListener, progressRequestListener);
        return call;
    ...
    public PersonalNameReligionedOut religionFull(String countryIso2, String subDivisionIso31662, String personalNameFull) throws ApiException {
        ApiResponse<PersonalNameReligionedOut> resp = religionFullWithHttpInfo(countryIso2, subDivisionIso31662, personalNameFull);
        return resp.getData();
    }
    ...
    public ApiResponse<PersonalNameReligionedOut> religionFullWithHttpInfo(String countryIso2, String subDivisionIso31662, String personalNameFull) throws ApiException {
        com.squareup.okhttp.Call call = religionFullValidateBeforeCall(countryIso2, subDivisionIso31662, personalNameFull, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call religionFullAsync(String countryIso2, String subDivisionIso31662, String personalNameFull, final ApiCallback<PersonalNameReligionedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = religionFullValidateBeforeCall(countryIso2, subDivisionIso31662, personalNameFull, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PersonalNameReligionedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call religionFullBatchCall(BatchPersonalNameGeoSubdivisionIn batchPersonalNameGeoSubdivisionIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call religionFullBatchValidateBeforeCall(BatchPersonalNameGeoSubdivisionIn batchPersonalNameGeoSubdivisionIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = religionFullBatchCall(batchPersonalNameGeoSubdivisionIn, progressListener, progressRequestListener);
        return call;
    ...
    public BatchPersonalNameReligionedOut religionFullBatch(BatchPersonalNameGeoSubdivisionIn batchPersonalNameGeoSubdivisionIn) throws ApiException {
        ApiResponse<BatchPersonalNameReligionedOut> resp = religionFullBatchWithHttpInfo(batchPersonalNameGeoSubdivisionIn);
        return resp.getData();
    }
    ...
    public ApiResponse<BatchPersonalNameReligionedOut> religionFullBatchWithHttpInfo(BatchPersonalNameGeoSubdivisionIn batchPersonalNameGeoSubdivisionIn) throws ApiException {
        com.squareup.okhttp.Call call = religionFullBatchValidateBeforeCall(batchPersonalNameGeoSubdivisionIn, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call religionFullBatchAsync(BatchPersonalNameGeoSubdivisionIn batchPersonalNameGeoSubdivisionIn, final ApiCallback<BatchPersonalNameReligionedOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = religionFullBatchValidateBeforeCall(batchPersonalNameGeoSubdivisionIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchPersonalNameReligionedOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call subclassificationCall(String countryIso2, String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call subclassificationValidateBeforeCall(String countryIso2, String firstName, String lastName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subclassificationCall(countryIso2, firstName, lastName, progressListener, progressRequestListener);
        return call;
    ...
    public FirstLastNameGeoSubclassificationOut subclassification(String countryIso2, String firstName, String lastName) throws ApiException {
        ApiResponse<FirstLastNameGeoSubclassificationOut> resp = subclassificationWithHttpInfo(countryIso2, firstName, lastName);
        return resp.getData();
    }
    ...
    public ApiResponse<FirstLastNameGeoSubclassificationOut> subclassificationWithHttpInfo(String countryIso2, String firstName, String lastName) throws ApiException {
        com.squareup.okhttp.Call call = subclassificationValidateBeforeCall(countryIso2, firstName, lastName, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call subclassificationAsync(String countryIso2, String firstName, String lastName, final ApiCallback<FirstLastNameGeoSubclassificationOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subclassificationValidateBeforeCall(countryIso2, firstName, lastName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FirstLastNameGeoSubclassificationOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call subclassificationBatchCall(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchFirstLastNameGeoIn;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call subclassificationBatchValidateBeforeCall(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = subclassificationBatchCall(batchFirstLastNameGeoIn, progressListener, progressRequestListener);
        return call;
    ...
    public BatchFirstLastNameGeoSubclassificationOut subclassificationBatch(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn) throws ApiException {
        ApiResponse<BatchFirstLastNameGeoSubclassificationOut> resp = subclassificationBatchWithHttpInfo(batchFirstLastNameGeoIn);
        return resp.getData();
    }
    ...
    public ApiResponse<BatchFirstLastNameGeoSubclassificationOut> subclassificationBatchWithHttpInfo(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn) throws ApiException {
        com.squareup.okhttp.Call call = subclassificationBatchValidateBeforeCall(batchFirstLastNameGeoIn, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call subclassificationBatchAsync(BatchFirstLastNameGeoIn batchFirstLastNameGeoIn, final ApiCallback<BatchFirstLastNameGeoSubclassificationOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subclassificationBatchValidateBeforeCall(batchFirstLastNameGeoIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchFirstLastNameGeoSubclassificationOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call subclassificationFullCall(String countryIso2, String fullName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call subclassificationFullValidateBeforeCall(String countryIso2, String fullName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subclassificationFullCall(countryIso2, fullName, progressListener, progressRequestListener);
        return call;
    ...
    public FirstLastNameGeoSubclassificationOut subclassificationFull(String countryIso2, String fullName) throws ApiException {
        ApiResponse<FirstLastNameGeoSubclassificationOut> resp = subclassificationFullWithHttpInfo(countryIso2, fullName);
        return resp.getData();
    }
    ...
    public ApiResponse<FirstLastNameGeoSubclassificationOut> subclassificationFullWithHttpInfo(String countryIso2, String fullName) throws ApiException {
        com.squareup.okhttp.Call call = subclassificationFullValidateBeforeCall(countryIso2, fullName, null, null);
        Type localVarReturnType = new TypeToken<FirstLastNameGeoSubclassificationOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call subclassificationFullAsync(String countryIso2, String fullName, final ApiCallback<FirstLastNameGeoSubclassificationOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subclassificationFullValidateBeforeCall(countryIso2, fullName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FirstLastNameGeoSubclassificationOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call subclassificationFullBatchCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchPersonalNameGeoIn;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call subclassificationFullBatchValidateBeforeCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = subclassificationFullBatchCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        return call;
    ...
    public BatchPersonalNameGeoSubclassificationOut subclassificationFullBatch(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        ApiResponse<BatchPersonalNameGeoSubclassificationOut> resp = subclassificationFullBatchWithHttpInfo(batchPersonalNameGeoIn);
        return resp.getData();
    }
    ...
    public ApiResponse<BatchPersonalNameGeoSubclassificationOut> subclassificationFullBatchWithHttpInfo(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        com.squareup.okhttp.Call call = subclassificationFullBatchValidateBeforeCall(batchPersonalNameGeoIn, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call subclassificationFullBatchAsync(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ApiCallback<BatchPersonalNameGeoSubclassificationOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subclassificationFullBatchValidateBeforeCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchPersonalNameGeoSubclassificationOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for usRaceEthnicityFull
     * @param personalNameFull  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call usRaceEthnicityFullCall(String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api2/json/usRaceEthnicityFull/{personalNameFull}"
            .replaceAll("\\{" + "personalNameFull" + "\\}", apiClient.escapeString(personalNameFull.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call usRaceEthnicityFullValidateBeforeCall(String personalNameFull, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'personalNameFull' is set
        if (personalNameFull == null) {
            throw new ApiException("Missing the required parameter 'personalNameFull' when calling usRaceEthnicityFull(Async)");
        }
        

        com.squareup.okhttp.Call call = usRaceEthnicityFullCall(personalNameFull, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PersonalNameUSRaceEthnicityOut usRaceEthnicityFull(String personalNameFull) throws ApiException {
        ApiResponse<PersonalNameUSRaceEthnicityOut> resp = usRaceEthnicityFullWithHttpInfo(personalNameFull);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PersonalNameUSRaceEthnicityOut> usRaceEthnicityFullWithHttpInfo(String personalNameFull) throws ApiException {
        com.squareup.okhttp.Call call = usRaceEthnicityFullValidateBeforeCall(personalNameFull, null, null);
        Type localVarReturnType = new TypeToken<PersonalNameUSRaceEthnicityOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call usRaceEthnicityFullAsync(String personalNameFull, final ApiCallback<PersonalNameUSRaceEthnicityOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = usRaceEthnicityFullValidateBeforeCall(personalNameFull, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PersonalNameUSRaceEthnicityOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for usRaceEthnicityFullBatch
     * @param batchPersonalNameGeoIn A list of personal names (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call usRaceEthnicityFullBatchCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = batchPersonalNameGeoIn;

        // create path and map variables
        String localVarPath = "/api2/json/usRaceEthnicityFullBatch";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call usRaceEthnicityFullBatchValidateBeforeCall(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = usRaceEthnicityFullBatchCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BatchPersonalNameUSRaceEthnicityOut usRaceEthnicityFullBatch(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        ApiResponse<BatchPersonalNameUSRaceEthnicityOut> resp = usRaceEthnicityFullBatchWithHttpInfo(batchPersonalNameGeoIn);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BatchPersonalNameUSRaceEthnicityOut> usRaceEthnicityFullBatchWithHttpInfo(BatchPersonalNameGeoIn batchPersonalNameGeoIn) throws ApiException {
        com.squareup.okhttp.Call call = usRaceEthnicityFullBatchValidateBeforeCall(batchPersonalNameGeoIn, null, null);
        Type localVarReturnType = new TypeToken<BatchPersonalNameUSRaceEthnicityOut>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call usRaceEthnicityFullBatchAsync(BatchPersonalNameGeoIn batchPersonalNameGeoIn, final ApiCallback<BatchPersonalNameUSRaceEthnicityOut> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = usRaceEthnicityFullBatchValidateBeforeCall(batchPersonalNameGeoIn, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BatchPersonalNameUSRaceEthnicityOut>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
