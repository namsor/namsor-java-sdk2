...
public class AdminApi {
     ...
     */
    public okhttp3.Call anonymizeCall(String source, Boolean anonymized, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call anonymizeValidateBeforeCall(String source, Boolean anonymized, final ApiCallback _callback) throws ApiException {
        ...
        return anonymizeCall(source, anonymized, _callback);
    ...
    public ApiResponse<Void> anonymizeWithHttpInfo(String source, Boolean anonymized) throws ApiException {
        okhttp3.Call localVarCall = anonymizeValidateBeforeCall(source, anonymized, null);
     ...
     */
    public okhttp3.Call anonymizeAsync(String source, Boolean anonymized, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = anonymizeValidateBeforeCall(source, anonymized, _callback);
     ...
     */
    public okhttp3.Call anonymize1Call(String source, Boolean anonymized, String token, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call anonymize1ValidateBeforeCall(String source, Boolean anonymized, String token, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'source' is set
        if (source == null) {
        ...
        return anonymize1Call(source, anonymized, token, _callback);
    ...
    public APIKeyOut anonymize1(String source, Boolean anonymized, String token) throws ApiException {
        ApiResponse<APIKeyOut> localVarResp = anonymize1WithHttpInfo(source, anonymized, token);
    ...
    public ApiResponse<APIKeyOut> anonymize1WithHttpInfo(String source, Boolean anonymized, String token) throws ApiException {
        okhttp3.Call localVarCall = anonymize1ValidateBeforeCall(source, anonymized, token, null);
     ...
     */
    public okhttp3.Call anonymize1Async(String source, Boolean anonymized, String token, final ApiCallback<APIKeyOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = anonymize1ValidateBeforeCall(source, anonymized, token, _callback);
        Type localVarReturnType = new TypeToken<APIKeyOut>(){}.getType();
