...
public class AdminApi {
    ...
    public APIKeyOut anonymize(String source, Boolean anonymized, String token) throws ApiException {
        ApiResponse<APIKeyOut> resp = anonymizeWithHttpInfo(source, anonymized, token);
        return resp.getData();
    }
     ...
     */
    public com.squareup.okhttp.Call anonymizeAsync(String source, Boolean anonymized, String token, final ApiCallback<APIKeyOut> callback) throws ApiException {
