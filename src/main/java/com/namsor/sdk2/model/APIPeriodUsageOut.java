...
public class APIPeriodUsageOut {
  ...
  **/
  @ApiModelProperty(value = "Overage amount including any tax.")
  ...
  **/
  @ApiModelProperty(value = "Overage amount including tax (if applicable).")
  ...
  **/
  @ApiModelProperty(value = "Currency of the overage amount.")
  ...
  **/
  @ApiModelProperty(value = "Quantity above monthly quota of the current subscritpion, in units.")
