...
public class BatchCommunityEngageOut {
  ...
  public BatchCommunityEngageOut engagementCandidates(List<CommunityEngageOut> engagementCandidates) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchCommunityEngageOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchCommunityEngageOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BatchCommunityEngageOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchCommunityEngageOut` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
