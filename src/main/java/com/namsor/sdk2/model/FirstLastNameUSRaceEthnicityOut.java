...
public class FirstLastNameUSRaceEthnicityOut {
  ...
  **/
  @ApiModelProperty(value = "The calibrated probability for raceEthnicity to have been guessed correctly.")
  ...
  **/
  @ApiModelProperty(value = "The calibrated probability for raceEthnicity OR raceEthnicityAlt to have been guessed correctly.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(script, id, firstName, lastName, raceEthnicityAlt, raceEthnicity, score, raceEthnicitiesTop, probabilityCalibrated, probabilityAltCalibrated);
  }
