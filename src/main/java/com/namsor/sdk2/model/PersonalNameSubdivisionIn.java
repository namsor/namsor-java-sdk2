...
public class PersonalNameSubdivisionIn {
  ...
  public PersonalNameSubdivisionIn id(String id) {
  ...
  **/
  ...
  public PersonalNameSubdivisionIn name(String name) {
  ...
  **/
  ...
  public PersonalNameSubdivisionIn subdivisionIso(String subdivisionIso) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonalNameSubdivisionIn
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PersonalNameSubdivisionIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonalNameSubdivisionIn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalNameSubdivisionIn` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
