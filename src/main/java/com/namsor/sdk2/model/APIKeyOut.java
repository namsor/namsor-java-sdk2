...
public class APIKeyOut {
  ...
  **/
   ...
   * @return explainable
  **/
  @ApiModelProperty(value = "The API Key supports the AI explainability option (may require a specific license).")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKey, userId, admin, vetted, learnable, anonymized, partner, striped, corporate, disabled, explainable, ipAddress);
  }
