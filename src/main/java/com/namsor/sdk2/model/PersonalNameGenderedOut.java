 ...
 */
@ApiModel(description = "Classified genderized names")
...
public class PersonalNameGenderedOut {
  ...
  **/
   ...
   * @return score
  **/
  @ApiModelProperty(value = "Compatibility to NamSor_v1 Gender score value. Higher score is better, but score is not normalized. Use calibratedProbability if available. ")
  ...
  **/
  @ApiModelProperty(value = "The calibrated probability for inferred gender to have been guessed correctly. -1 = still calibrating. ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(script, id, name, likelyGender, genderScale, score, probabilityCalibrated);
  }
