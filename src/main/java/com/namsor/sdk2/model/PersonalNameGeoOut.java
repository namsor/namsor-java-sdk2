...
public class PersonalNameGeoOut {
  ...
  **/
  @ApiModelProperty(value = "The calibrated probability for country to have been guessed correctly.")
  ...
  **/
  @ApiModelProperty(value = "The calibrated probability for country OR countryAlt to have been guessed correctly.")
