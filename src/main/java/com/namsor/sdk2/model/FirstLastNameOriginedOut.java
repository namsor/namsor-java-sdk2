...
public class FirstLastNameOriginedOut {
  ...
  **/
  @ApiModelProperty(value = "The calibrated probability for countryOrigin to have been guessed correctly. -1 = still calibrating. ")
  ...
  **/
  @ApiModelProperty(value = "The calibrated probability for countryOrigin OR countryOriginAlt to have been guessed correctly. -1 = still calibrating. ")
  ...
  **/
  @ApiModelProperty(value = "Geographic religious statistics, assuming country of origin is correctly predicted.")
  ...
  **/
  @ApiModelProperty(value = "Geographic religious statistics, for origin best alternative.")
