...
public class PersonalNameGeoSubdivisionIn {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonalNameGeoSubdivisionIn
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PersonalNameGeoSubdivisionIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonalNameGeoSubdivisionIn is not found in the empty JSON string", PersonalNameGeoSubdivisionIn.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonalNameGeoSubdivisionIn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalNameGeoSubdivisionIn` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonalNameGeoSubdivisionIn.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonalNameGeoSubdivisionIn' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonalNameGeoSubdivisionIn> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonalNameGeoSubdivisionIn.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonalNameGeoSubdivisionIn>() {
           @Override
           public void write(JsonWriter out, PersonalNameGeoSubdivisionIn value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonalNameGeoSubdivisionIn read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PersonalNameGeoSubdivisionIn given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PersonalNameGeoSubdivisionIn
  * @throws IOException if the JSON string is invalid with respect to PersonalNameGeoSubdivisionIn
  */
  public static PersonalNameGeoSubdivisionIn fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonalNameGeoSubdivisionIn.class);
  }

 /**
  * Convert an instance of PersonalNameGeoSubdivisionIn to an JSON string
  *
  * @return JSON string
  */
