...
public class PersonalApiTest {
     ...
     */
    @Test
    public void corridorFullTest() throws ApiException {
        String countryIso2From = null;
        String personalNameFrom = null;
        String countryIso2To = null;
        String personalNameTo = null;
        CorridorFullOut response = api.corridorFull(countryIso2From, personalNameFrom, countryIso2To, personalNameTo);
     ...
     */
    @Test
    public void corridorFullBatchTest() throws ApiException {
        BatchCorridorFullIn batchCorridorFullIn = null;
        BatchCorridorFullOut response = api.corridorFullBatch(batchCorridorFullIn);
