...
public class AdminApiTest {
    ...
    public void apiStatusTest() throws ApiException {
        APIPlansOut response = api.apiStatus();
     ...
     */
    @Test
    public void removeUserAccountOnBehalfTest() throws ApiException {
        String apiKey = null;
        APIPlanSubscriptionOut response = api.removeUserAccountOnBehalf(apiKey);
     ...
     */
    @Test
    public void subscribePlanOnBehalfTest() throws ApiException {
        String planName = null;
        String apiKey = null;
        APIPlanSubscriptionOut response = api.subscribePlanOnBehalf(planName, apiKey);
    ...
    public void taxonomyClassesTest() throws ApiException {
        ...
        APIPlansOut response = api.taxonomyClasses(classifierName);
